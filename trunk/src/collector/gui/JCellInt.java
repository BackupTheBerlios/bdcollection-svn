...
public class JCellInt extends JCell
{
	...
	public void actionPerformed(ActionEvent evt) {
	    ...
	    int value;
	    try {
		value = new Integer(textStr).intValue();
	    } catch(NumberFormatException t) {
		value = Element.NUL_INT;
	    }
 	    data.setData( value);
	    //textField.selectAll();
	}
	...
	public void insertUpdate(DocumentEvent e) {
		...
		data.setData( value);
		//data.setData( new Integer(textStr).intValue() );
