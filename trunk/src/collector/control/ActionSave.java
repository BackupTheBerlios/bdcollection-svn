...
public class ActionSave extends AbstractAction 
{
    ...
    /** Creation */
    ActionSave( Actions p_actions )
    {
	super();
	logger = Logger.getLogger(Actions.class);
	
	// set Properties
	putValue( AbstractAction.NAME, new String( "Sauver BDD" ));
	...
	putValue( AbstractAction.SHORT_DESCRIPTION, new String( "Sauvegarde la Base de Donnée actuelle dans un Fichier." ));
    ...
    aFileChooser.setSelectedFile( theActions.theJBDD.theBDD.fileDesc );
